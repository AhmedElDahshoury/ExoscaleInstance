...
public class OperationApi {
     ...
     */
    public okhttp3.Call getOperationCall(UUID id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getOperationValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getOperation(Async)");
        }

        return getOperationCall(id, _callback);
    ...
    public Operation getOperation(UUID id) throws ApiException {
        ApiResponse<Operation> localVarResp = getOperationWithHttpInfo(id);
    ...
    public ApiResponse<Operation> getOperationWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getOperationValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Operation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve Operation details (asynchronously)
     * 
     * @param id  (required)
     ...
     */
    public okhttp3.Call getOperationAsync(UUID id, final ApiCallback<Operation> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOperationValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Operation>(){}.getType();
