...
import openapiclient.src.main.java.org.openapitools.client.model.ListZones200Response;
...
public class ZoneApi {
     ...
     */
    public okhttp3.Call listZonesCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listZonesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return listZonesCall(_callback);
    ...
    public ListZones200Response listZones() throws ApiException {
        ApiResponse<ListZones200Response> localVarResp = listZonesWithHttpInfo();
    ...
    public ApiResponse<ListZones200Response> listZonesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listZonesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<ListZones200Response>(){}.getType();
     ...
     */
    public okhttp3.Call listZonesAsync(final ApiCallback<ListZones200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listZonesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<ListZones200Response>(){}.getType();
