...
public class ListAntiAffinityGroups200Response {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ListAntiAffinityGroups200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAntiAffinityGroups200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAntiAffinityGroups200Response is not found in the empty JSON string", ListAntiAffinityGroups200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAntiAffinityGroups200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAntiAffinityGroups200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAntiAffinityGroups200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAntiAffinityGroups200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAntiAffinityGroups200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAntiAffinityGroups200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAntiAffinityGroups200Response>() {
           @Override
           public void write(JsonWriter out, ListAntiAffinityGroups200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAntiAffinityGroups200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListAntiAffinityGroups200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAntiAffinityGroups200Response
  * @throws IOException if the JSON string is invalid with respect to ListAntiAffinityGroups200Response
  */
  public static ListAntiAffinityGroups200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAntiAffinityGroups200Response.class);
  }

 /**
  * Convert an instance of ListAntiAffinityGroups200Response to an JSON string
  *
  * @return JSON string
  */
