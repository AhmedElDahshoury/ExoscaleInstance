...
public class InternalAuthenticationBackendLimiting {
   ...
   */
  @JsonAdapter(AuthenticationBackendEnum.Adapter.class)
  public enum AuthenticationBackendEnum {
    ...
    public static class Adapter extends TypeAdapter<AuthenticationBackendEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AuthenticationBackendEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AuthenticationBackendEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AuthenticationBackendEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_AUTHENTICATION_BACKEND = "authentication_backend";
  @SerializedName(SERIALIZED_NAME_AUTHENTICATION_BACKEND)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("authentication_backend");
  ...
  * @throws IOException if the JSON Element is invalid with respect to InternalAuthenticationBackendLimiting
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InternalAuthenticationBackendLimiting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InternalAuthenticationBackendLimiting is not found in the empty JSON string", InternalAuthenticationBackendLimiting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InternalAuthenticationBackendLimiting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InternalAuthenticationBackendLimiting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("authentication_backend") != null && !jsonObj.get("authentication_backend").isJsonNull()) && !jsonObj.get("authentication_backend").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authentication_backend` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authentication_backend").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InternalAuthenticationBackendLimiting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InternalAuthenticationBackendLimiting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InternalAuthenticationBackendLimiting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InternalAuthenticationBackendLimiting.class));

       return (TypeAdapter<T>) new TypeAdapter<InternalAuthenticationBackendLimiting>() {
           @Override
           public void write(JsonWriter out, InternalAuthenticationBackendLimiting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InternalAuthenticationBackendLimiting read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InternalAuthenticationBackendLimiting given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InternalAuthenticationBackendLimiting
  * @throws IOException if the JSON string is invalid with respect to InternalAuthenticationBackendLimiting
  */
  public static InternalAuthenticationBackendLimiting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InternalAuthenticationBackendLimiting.class);
  }

 /**
  * Convert an instance of InternalAuthenticationBackendLimiting to an JSON string
  *
  * @return JSON string
  */
