...
public class CreateInstancePoolRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateInstancePoolRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateInstancePoolRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInstancePoolRequest is not found in the empty JSON string", CreateInstancePoolRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInstancePoolRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInstancePoolRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateInstancePoolRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateInstancePoolRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateInstancePoolRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateInstancePoolRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateInstancePoolRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateInstancePoolRequest>() {
           @Override
           public void write(JsonWriter out, CreateInstancePoolRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateInstancePoolRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateInstancePoolRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateInstancePoolRequest
  * @throws IOException if the JSON string is invalid with respect to CreateInstancePoolRequest
  */
  public static CreateInstancePoolRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInstancePoolRequest.class);
  }

 /**
  * Convert an instance of CreateInstancePoolRequest to an JSON string
  *
  * @return JSON string
  */
