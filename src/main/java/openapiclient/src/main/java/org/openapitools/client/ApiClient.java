...
public class ApiClient {
    ...
    private String basePath = "https://api-ch-gva-2.exoscale.com/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-{zone}.exoscale.com/v2",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("zone", new ServerVariable(
          "No description provided",
          "ch-gva-2",
          new HashSet<String>(
            Arrays.asList(
    ...
    new ServerConfiguration(
      "https://ppapi-{zone}.exoscale.com/v2",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("zone", new ServerVariable(
          "No description provided",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-ch-gva-2.exoscale.com/v2
