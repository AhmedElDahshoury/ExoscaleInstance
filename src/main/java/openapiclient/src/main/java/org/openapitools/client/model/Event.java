...
public class Event {
  ...
  public static final String SERIALIZED_NAME_REMOTE_ADDR = "remote-addr";
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("remote-addr") != null && !jsonObj.get("remote-addr").isJsonNull()) && !jsonObj.get("remote-addr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `remote-addr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("remote-addr").toString()));
      }
