...
public class DbaasServiceKafkaUsersInner {
  ...
  public static final String SERIALIZED_NAME_ACCESS_CERT_EXPIRY = "access-cert-expiry";
  @SerializedName(SERIALIZED_NAME_ACCESS_CERT_EXPIRY)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("access-cert-expiry");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DbaasServiceKafkaUsersInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DbaasServiceKafkaUsersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DbaasServiceKafkaUsersInner is not found in the empty JSON string", DbaasServiceKafkaUsersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DbaasServiceKafkaUsersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DbaasServiceKafkaUsersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DbaasServiceKafkaUsersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DbaasServiceKafkaUsersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DbaasServiceKafkaUsersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DbaasServiceKafkaUsersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DbaasServiceKafkaUsersInner>() {
           @Override
           public void write(JsonWriter out, DbaasServiceKafkaUsersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DbaasServiceKafkaUsersInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DbaasServiceKafkaUsersInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DbaasServiceKafkaUsersInner
  * @throws IOException if the JSON string is invalid with respect to DbaasServiceKafkaUsersInner
  */
  public static DbaasServiceKafkaUsersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DbaasServiceKafkaUsersInner.class);
  }

 /**
  * Convert an instance of DbaasServiceKafkaUsersInner to an JSON string
  *
  * @return JSON string
  */
